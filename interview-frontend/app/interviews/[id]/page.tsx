...
//   const [hoveredQuestion, setHoveredQuestion] = useState<number | null>(null); // ✅ ADDED
...
//         </h2>
//         {loadingAll && (
//           <span style={{ fontSize: 13, color: "rgba(240,240,255,0.4)" }}>Loading responses...</span>
//         )}
//       </div>
...
//                     }}
//                     onMouseEnter={() => setHoveredQuestion(i)}  // ✅ ADDED
//                     onMouseLeave={() => setHoveredQuestion(null)} // ✅ ADDED
//                   >
...
//                     {/* ✅ ADDED: Full text popup on hover */}
//                     {hoveredQuestion === i && (
//                       <div style={{
//                         position: "absolute",
//                         top: "100%",
